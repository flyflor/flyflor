...
- Use the provided file tool for text reading, full-file writing, guarded text edits, and file deletion when file access is needed.
- Use shell only for read-only local exploration.
