...
export class WorkerManager {
    ...
    register<TInput, TOutput>(
        ...
        const metadata = fpcComponents.assertKind(instance.constructor, ComponentKind.Worker);
    ...
    private publishRegistered(registration: WorkerRegistration): void {
        this.events.publish(
            event(FpcEventType.WorkerRegistered, {
                kind: registration.metadata.kind,
                layer: registration.metadata.layer,
                name: registration.name,
                runtime: registration.runtime,
