 ...
 */
export type InferenceStopReason = 'stop' | 'length' | 'toolUse';
...
export type InferenceEvent =
    ...
    | { type: 'done'; stopReason: InferenceStopReason };
...
export interface ProtocolAdapter {
    ...
    parseLine(controller: ReadableStreamDefaultController<InferenceEvent>, line: string, state: ProtocolStreamState): boolean;
}
