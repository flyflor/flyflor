...
export const GatewayControlMessageType = {
    ...
    ConfirmDetailGet: "confirm.detail.get",
    ConfirmList: "confirm.list",
    ConfirmSnapshot: "confirm.snapshot",
    Error: "error",
    EventPublish: "event.publish",
    EventSubscribe: "event.subscribe",
    EventUnsubscribe: "event.unsubscribe",
    ExecutionJobDetailGet: "execution.job.detail.get",
    ExecutionJobList: "execution.job.list",
    ExecutionJobSnapshot: "execution.job.snapshot",
    GatewayMessageInterrupt: "gateway.message.interrupt",
    GatewayMessageSend: "gateway.message.send",
    GatewayMessageUndo: "gateway.message.undo",
