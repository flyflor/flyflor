...
export const RuntimeEventType = {
    ...
    MemoryJournalRejectedLegacy: "memory.journal.rejected.legacy",
    ...
    MemoryGhostRecorded: "memory.ghost.recorded",
    MemoryGhostResumed: "memory.ghost.resumed",
    MemoryGhostDropped: "memory.ghost.dropped",
    MemoryGhostPinned: "memory.ghost.pinned",
    MemoryGhostDecisionApplied: "memory.ghost.decision.applied",
