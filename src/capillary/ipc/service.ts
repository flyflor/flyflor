...
/** Minimum user message length accepted by IPC before forwarding into the runtime. */
 ...
 *
 * It intentionally does not own LLM logic. External transports hand a user message in; this service
 * forwards it to the runtime and returns the agent reply.
 */
@Service()
export class IPCService extends FService {
    ...
    /**
     * Forwards one user message from any IPC transport into the runtime.
