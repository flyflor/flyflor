...
import { normalizeBlackboardWorkerOutput } from "./blackboard.normalize.ts";
...
export { normalizeBlackboardWorkerOutput as normalizeModelWorkerResult } from "./blackboard.normalize.ts";
