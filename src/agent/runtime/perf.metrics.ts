...
export class PerfMetrics {
    ...
    constructor(config: MetricsConfig, events: EventSink) {
     ...
     */
    mark<T extends Record<string, unknown>>(
        type: PerfEventType,
        baseline: T = {} as T,
        requestId?: string,
    ...
    record(type: PerfEventType, payload: Record<string, unknown>, requestId?: string): void {
