...
import { Session } from "../components.ts";
...
@Module({ name: "session", tags: ["flyflor", "boundary"] })
@Provide({ kind: ComponentKind.Session, layer: ArchitectureLayer.Control, name: "session", provider: true })
export class SessionModule extends Session {
    constructor(
