...
export class SocketServerService {
  ...
  private attachRuntimeBroadcasts(): readonly { readonly unsubscribe: () => void }[] {
    ...
    const types = [
      ...
      "worker.failed",
      "worker.queued",
      "worker.result.injected",
      "sandbox.inspected",
      "sandbox.approved",
      "sandbox.denied",
      "sandbox.escalated",
      "sandbox.pattern.learned",
      "sandbox.anomaly.detected",
      "scope.detected",
      "scope.activated",
      "scope.deactivated",
      "scope.candidate.nominated",
      "scope.created",
      "scope.recall_mode.started",
      "scope.recall_mode.ended",
      "crystal.ask.created",
      "crystal.ask.answered",
      "crystal.ask.resolved",
      "crystal.ask.timeout",
      "crystal.candidate.formed",
      "crystal.candidate.reinforced",
      "crystal.candidate.ready",
      "crystal.gem.elevated",
      "crystal.gem.loaded",
      "crystal.gem.applied",
      "crystal.gem.expired",
      "crystal.eq.adjusted",
      "forgetting.cycle.started",
      "forgetting.chunk.compacted",
      "forgetting.chunk.faded",
      "forgetting.fact.aged",
      "forgetting.gem.drifted",
      "forgetting.cycle.completed",
      "forgetting.schedule.adjusted",
    ];
