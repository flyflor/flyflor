...
.liquid-glass-web-approx::before {
    ...
    background: radial-gradient(circle at 20% 0%, rgb(255 255 255 / 0.55), transparent 34%), linear-gradient(90deg, rgb(255 255 255 / 0.18), transparent 42%, rgb(255 255 255 / 0.14));
    pointer-events: none;
}
