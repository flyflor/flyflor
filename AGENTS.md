...
2. Runtime code is OOP-first. Business behavior belongs on classes extending the correct core base class: `FModule`, `FService`, `FComponent`, `FFile`, `FRepo`, `FPlugin`, `FGuard`, `FSandBox`, `FAgent`, or `FCortex`.
