            ...
            <section class="auth-panel surface-panel">
                ...
                <form class="auth-form" @submit.prevent="submitRegister">
                    ...
                    <label>
                        ...
                        <input v-model="password" autocomplete="new-password" minlength="8" required type="password" />
                    </label>
                ...
                <p class="auth-switch">
                    ...
                    <NuxtLink :to="`/${locale}/auth/login`">{{ content.auth.login }}</NuxtLink>
                </p>
            </section>
        </main>
...
async function submitRegister(): Promise<void> {
    ...
    try {
        ...
        error.value = requestError instanceof Error ? requestError.message : "Registration failed.";
    }
}
