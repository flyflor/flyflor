...
- 当前分支只拥有 context-memory 切片：`src/cognitive/hippocampus/memory/**`、`src/entities/memory/**`、`src/agent/context/**` 与直接相关测试。
- 未经主线协调者批准，不修改 `src/cognitive/crystal/**`、`src/agent/runtime/**`、`src/agent/gateway/**`、`src/executive/**`。
