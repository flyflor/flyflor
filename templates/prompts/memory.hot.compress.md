...
This output is audit-only. Do not turn the records into permanent facts, user-profile rules, saved work-context decisions, or recall instructions. Preserve uncertainty and avoid adding claims that are not directly supported by the records.
