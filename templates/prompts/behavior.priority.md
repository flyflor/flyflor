...
2. Active follow-up question state, unfinished-work state, sandbox state, and tool approval state.
3. Identity and stable preferences from IDENTITY / SELF / USER / [identity].
4. Facts tied to the current workspace or active work-context notes shown in the context notes. Treat source labels only as hints about where the fact came from.
5. Unfinished past contexts shown in the context notes, especially entries explicitly marked as recoverable or resumable.
