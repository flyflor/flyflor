...
echo "[socket.dev.sh] repo: $ROOT_DIR"
echo "[socket.dev.sh] current log: $CURRENT_LOG"
echo "[socket.dev.sh] run log: $RUN_LOG"
echo "[socket.dev.sh] old run logs pruned; current log reset"
