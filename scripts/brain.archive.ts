 ...
 *
 * The reusable implementation lives in `src/cognitive/hippocampus/memory/brain/archive.ts`
 * so runtime automation and this admin script share one contract.
 */

import { runBrainArchive } from "../src/cognitive/hippocampus/memory/brain/index.ts";
